...
def analysis(diagnosis, weight_input):
    weight_input = input("Enter weight: ")
...
def output(weight, dosage_mg_first_day):
    ...
    print("  the correct dosage is {:.1f} mg the first day".format(
        dosage_mg_first_day))


if __name__ == '__main__':
    diagnosis, weight_input = input_data()
weight, dosage_mg_first_day = analysis(diagnosis, weight_input)
ouput(weight, dosage_mg_first_day)
